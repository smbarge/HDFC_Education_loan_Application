<script>
  ...
  //   let property = {};
  //   if (property_type == 1) {
  //     property = addResidentialProperty();
  //   } else if (property_type == 2) {
  //     property = addCommercialProperty();
  //   } else if (property_type == 3) {
  //     property = addAgriProperty();
  //   } else if (property_type == 4) {
  //     property = addOpenProperty();
  //   }
  ...
  const toggleModal = () => {
    property_type = 0,
    residentialProperty.sub_property = "",
    commercialProperty.sub_property = "",
    agriProperty.sub_property = "",
    openProperty.sub_property = "",
    isModalOpen = !isModalOpen;
  };
  // Commercial
  let property_type = 0;
  ...
  >
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow">
          ...
          <form>
            <fieldset>
              <legend class="text-base font-medium text-gray-900 pb-2">
                ...
                <span class="px-14">कृपया संपत्तीचा प्रकार निवडा</span>
              </legend>
                  ...
                  {#each propertyTypes as prop, i}
                    <div
                      class={`flex flex-col flex-wrap items-center justify-center px-2 m-2 p-3 rounded shadow ${
                        property_type == prop.id ? "bg-gray-200" : "bg-gray-100"
                      }`}
                    >
                      <input
                        ...
                        bind:group={property_type}
                        on:change={() => {
                          residentialSubtype = ""; // Reset subtype when property type changes
                        }}
                      />
                      <label
              ...
              {#if property_type == 1}
                <div class="mx-2 mb-4 space-y-2">
                  <legend class="text-base font-medium text-gray-900 pb-2 px-4">
                ...
                <!-- <pre>
                  {JSON.stringify(residentialSubtype, null, 2)}
                </pre>
                <pre>
                  {JSON.stringify(residentialProperty, null, 2)}
                </pre> -->
                {#if residentialProperty.sub_property}
                  <!-- Only show the input form when a subtype is selected -->
                  <Residential
                    ...
                    {alertMsg}
                    documentType={residentialSubtype}
                  />
                {/if}
              {:else if property_type == 2}
                <div class="mx-2 mb-4 space-y-2">
                ...
                {#if commercialProperty.sub_property}
                  <Commercial
                    ...
                    {alertMsg}
                    documentType={commercialProperty.sub_property}
                  />
                {/if}
              {:else if property_type == 3}
                <div class="mx-2 mb-4 space-y-2">
                ...
                {#if agriProperty.sub_property}
                  <AgriLand
                    ...
                    {alertMsg}
                    documentType={agriProperty.sub_property}
                  />
                {/if}
              {:else if property_type == 4}
                <div class="mx-2 mb-4 space-y-2">
                ...
                {#if openProperty.sub_property}
                  <OpenPlot
                    ...
                    {alertMsg}
                    documentType={openProperty.sub_property}
                  />
                {/if}
              {/if}
            </fieldset>
        ...
        >
          {#if property_type && (property_type != 1 || (property_type == 1 && residentialProperty.sub_property))}
            <button
              on:click={onAdd}
              type="button"
