<script>
  ...
  const verifiedDetails = async () => {
    try {
      ...
      if (verificationDetails?.mobile_no_applicant?.length > 0) {
        data.mobile = verificationDetails.mobile_no_applicant;
      }
    } catch (e) {
        ...
        >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      Enter your verification code / आपला पडताळणी कोड प्रविष्ट
                      करा
                    </h2>
                    <button
                      on:click={() => {
                  ...
                  <div class="py-5">
                    ...
                    <h1
                      class="md:text-1xl text-xl text-gray-500 text-center font-semibold font-robotoMono"
                    >
                      पडताळणी कोड
                    </h1>

                    <h1
                      class="md:text-sm text-xs font-inter text-gray-400 text-center pb-1"
                    >
                      We have sent the verification code to Your Mobile Number
                    </h1>
                    <h1 class="text-gray-400 text-center pb-4">
                      आम्ही तुमच्या मोबाईल नंबरवर पडताळणी कोड पाठवला आहे
                    </h1>
                    <h1
          ...
          <div class="col-span-1">
            <label
              for="rationCard"
              class="block text-sm font-semibold text-gray-500"
              >Ration Card Number/रेशन कार्ड नंबर <span class="text-red-500"
                >*</span
              >
            </label>
            <div class="mt-1 relative">
          ...
          <div class="grid grid-cols-12 lg:gap-5 gap-3 lg:px-5 py-5">
            <div class="col-span-12">
              <label
                for="streetAddress"
                class="block text-sm font-semibold text-gray-500"
                >Current Street Address/सध्याचा रस्ता पत्ता
            ...
            <label class="flex items-center gap-2 cursor-pointer">
              ...
              <div>
                <h1 class="block text-gray-600 font-roboto text-sm">
                  ...
                  <h1>तुमचा सध्याचा पत्ता तुमचा कायमचा पत्ता आहे का?</h1>
                </h1>
              </div>
            </label>
          </div>
          ...
          <div class="grid grid-cols-12 lg:gap-5 gap-3 lg:px-5 py-5">
            <div class="col-span-12">
              <label
                for="streetAddress1"
                class="block text-sm font-semibold text-gray-500"
                >Permanent Street Address/कायमचा पत्ता
              </label>
              <div class="mt-1 relative">
                <div
                  class="absolute inset-y-0 left-0 px-3 flex items-center pointer-events-none border-r border-gray-300"
