<script>
  ...
  const init = async () => {
    ...
    if (
      details.find(
        (e) => e.field_name == "aadhar" && e.table_name == "personalDetails"
      )
    ) {
      aadharDetails = {
        aadhar: details.find((e) => e.field_name == "aadhar" && e.table_name == "personalDetails")?.value,
        name: details.find((e) => e.field_name == "name" && e.table_name == "personalDetails")?.value,
        // dob: application.personalDetails.dob.split("T")[0],
        // dob: details.find((e) => e.field_name == "dob" && e.table_name == "personalDetails")?.value.split("T")[0],
        dob:formatDate(details.find((e) => e.field_name == "dob" && e.table_name == "personalDetails")?.value),

        permanent_address: details.find(
          (e) => e.field_name == "permanent_address" && e.table_name == "personalDetails"
        )?.value,
        permanent_taluka: details.find(
          (e) => e.field_name == "permanent_taluka" && e.table_name == "personalDetails"
        )?.value,
        permanent_district: details.find(
          (e) => e.field_name == "permanent_district" && e.table_name == "personalDetails"
        )?.value,
        permanent_place: details.find((e) => e.field_name == "permanent_place" && e.table_name == "personalDetails")
          ?.value,
        permanent_pincode: details.find(
          (e) => e.field_name == "permanent_pincode" && e.table_name == "personalDetails"
        )?.value,
      };
    } else {
      aadharDetails = {
        aadhar: application.personalDetails.aadhar,
        name: application.personalDetails.name,
        // dob: application.personalDetails.dob.split("T")[0],
        dob:formatDate(application.personalDetails.dob), 
        permanent_address: application.personalDetails.permanent_address,
        permanent_taluka: application.personalDetails.permanent_taluka,
        permanent_district: application.personalDetails.permanent_district,
        permanent_place: application.personalDetails.permanent_place,
        permanent_pincode: application.personalDetails.permanent_pincode,
      };
    }
  };
  ...
  function areDetailsEqual(aadharDetails, personalDetails) {
    if (details.find((e) => e.field_name == "aadhar")) {
      if (
        aadharDetails["aadhar"] !==
        details.find((e) => e.field_name == "aadhar")?.value
      ) {
        return false;
      }
      if (
        aadharDetails["name"] !==
        details.find((e) => e.field_name == "name")?.value
      ) {
        return false;
      }
      ...
      if (
        aadharDetails["dob"] !==
        details.find((e) => e.field_name == "dob")?.value
      ) {
        return false;
      }
      ...
      if (
        ...
        details.find((e) => e.field_name == "permanent_address")?.value
      ) {
        return false;
      }
      if (
        aadharDetails["permanent_taluka"] !==
        details.find((e) => e.field_name == "permanent_taluka")?.value
      ) {
        return false;
      }
      if (
        aadharDetails["permanent_district"] !==
        details.find((e) => e.field_name == "permanent_district")?.value
      ) {
        return false;
      }
      if (
        aadharDetails["permanent_place"] !==
        details.find((e) => e.field_name == "permanent_place")?.value
      ) {
        return false;
      }
      if (
        aadharDetails["permanent_pincode"] !==
        details.find((e) => e.field_name == "permanent_pincode")?.value
      ) {
        return false;
      }
      return true;
      ...
      for (const key in aadharDetails) {
        if (aadharDetails[key] !== personalDetails[key]) {
  ...
  const onSubmit = async () => {
    ...
    const isEqual = areDetailsEqual(aadharDetails, application.personalDetails);
    ...
    <div class="flex-1">
      ...
      >
        <h1 class="text-xl font-semibold text-left text-Calypso-500">
          1. Applicant Aadhar Card Details
        </h1>
      </button>
      <div class="mt-6">
